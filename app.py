...
def index(id):
    ...
    user = {
            ...
            "project1_skills": user_data.project1_skills.split(",") if "," in  user_data.project2_skills else [user_data.project1_skills,],

            "project2_name": user_data.project2_name,
            "project2_description": user_data.project2_description,
            "project2_skills": user_data.project2_skills.split(",") if "," in  user_data.project2_skills else [user_data.project2_skills,],

            "project3_name": user_data.project3_name,
            "project3_description": user_data.project3_description,
            "project3_skills": user_data.project3_skills.split(",") if "," in  user_data.project3_skills else [user_data.project3_skills,],
